    ...
    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="panel panel-custom">
                                ...
                                <div class="panel-body">
                                    <img src="<?php echo $listaProdutos[$i]->getTxImgUrl(); ?>" class="img-responsive" alt="Image">
                                </div>
        ...
        <div class="col-lg-2 col-lg-pull-10 col-md-3 col-md-pull-9 col-xs-12">
            ...
            <ul class="list-unstyled">
                ...
                <a class="btn btn-button texto-cor-custom menu-esq-botao" href="index.php?pagina=produtos&idCategoria=0">
                ...
                <?php } ?>
                <li>
                    <a class="btn btn-button texto-cor-custom menu-esq-botao" href="index.php?pagina=produtos&idPromocao=1">
                <li>PROMOÇÕES</li></a>
                </li>
            </ul>
        </div>
